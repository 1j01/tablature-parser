...
describe "Tablature.parse()", ->
	...
	it "should ignore lyrics with hyphens", ->
		parse """
			
			   This was a tri-umph        I’m mak-ing a note here:  huge suc-cess
			
			e|--3----2--0--0---2---------------3---2--0--0----2-----------0-------------|
			B|-------------------------------------------------------3------------------|
			G|-----------------------------2----------------------------------2---------|
			D|--------------------------------------------------------------------------|
			A|--------------------------------------------------------------------------|
			E|--------------------------------------------------------------------------|
			   ...
			   It’s hard to ov-er state my sat-is-fac-tion
